feature 'Reviews', :js do
  ...
  context 'when logged in user' do
    let!(:user) { create(:user, email: 'admin2@person.com', password: 'password', password_confirmation: 'password') }
  ...
  context 'visits product with review where show_identifier is false' do
    let!(:user) { create(:user, email: 'admin3@person.com', password: 'password', password_confirmation: 'password') }
